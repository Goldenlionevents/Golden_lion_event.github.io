  ...
  <nav class="navbar" id="home">
    ...
    <h1 class="text09">fill out the form to register</h1>
      <div class="flex">
         ...
         <div class="inputBox">
            <span>user name :</span>
            <input type="text" placeholder="ex: user102" name="username" required>
         </div>
         <div class="inputBox">
            <span>password :</span>
            ...
            <input type="password" name="passwordcheck" placeholder="check password" requireds>
         </div>
      </div>

      <input type="submit" value="sign in" class="btn" name="send">
      <span class="text10">
                <span><br/> <br/>already have anaccount! sign in <a href='sign in.php'><u>here </u> </a></span>
                <br />
